...
object Constants {
    ...
    //Room Base
    const val DATABASE_NAME = "gil_db"
    const val DATABASE_CONTACTS_TABLE = "tc_contacts"
    const val DATABASE_FRIENDS_TABLE = "tc_friends"
    const val DATABASE_EVENTS_TABLE = "tc_events"
